const Footer = () => {
  return (
    <footer className="relative">
      ...
      ;
      <div className="bg-[#FFF8E7] p-4 sm:p-6 md:p-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              {/* Customer Care Section - Moved to first column on mobile */}
            ...
            {/* Customer Care Section - Hidden on mobile */}
            ...
            {/* Newsletter Section */}
            <div className="w-full p-4 rounded-lg shadow-lg border-2 border-black bg-white">
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <input
                    ...
                    className="p-2 rounded border-2 border-black w-full"
                  />
                  <input
                    type="text"
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-0">
                  <input
                    ...
                    className="p-2 rounded sm:rounded-r-none border-2 sm:border-r-0 border-black flex-grow"
                  />
                  <button className="bg-[#FFA500] text-black font-bold px-4 py-2 rounded sm:rounded-l-none border-2 border-black hover:bg-[#FF9000] transition-colors">
                    SUBSCRIBE
                  </button>
                </div>
              </form>
