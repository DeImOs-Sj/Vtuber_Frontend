...
const Middle = () => {
  return (
    <div className="max-w-[100%] mx-auto p-8 sm:px-4">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-12">
        ...
        <div className="sm:col-span-7 space-y-4">
          ...
          <div className="flex gap-2 ">
            <div className="flex flex-col items-start w-1/2  border-black border-2 rounded-lg p-4">
              ...
              {/* Black Star Button */}
              <div className="relative mt-10 mb-10 sm:left-auto sm:transform-none sm:relative">
                <div className="absolute inset-0 bg-black transform rotate-45 sm:scale-75"></div>
                <div
                  className="relative bg-black text-white p-4 sm:p-2 transform rotate-12
        ...
        {/* Center Divider */}
        <div className="hidden sm:block sm:col-span-1 flex justify-center bg-black rounded-2xl">
